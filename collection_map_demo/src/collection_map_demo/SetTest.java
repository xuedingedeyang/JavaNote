...
//				temp5.name+";"+temp6.id+":"+temp6.name);
	...
	public void testListContains(){
		...
		//创建一个新的课程对象，ID与名称，与course对象完全一样
		...
		if(coursesToSelect.contains(course2))
			System.out.println("课程"+course2.name+"的索引位置为："+coursesToSelect.lastIndexOf(course2));
		//通过lastIndexOf方法取得某元素最后一次出现的索引位置
		Course course3 = new Course("7","C语言");
		coursesToSelect.add(course3);
		if(coursesToSelect.contains(course3))
			System.out.println("课程"+course3.name+"的索引位置为："+coursesToSelect.lastIndexOf(course3));
	}
