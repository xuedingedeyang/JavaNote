...
public class DeleteT implements ActionListener {
	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					PreparedStatement ps = conn.prepareStatement("delete from teacher where Tno = ?");				
					ps.setString(1, Tno);
					ps.executeUpdate();
					conn.commit();
